...
def helpMessage() {
    ...
    --forward_primer    Forward primer sequence. Default to F27. (default: AGRGTTYGATYMTGGCTCAG)
    --reverse_primer    Reverse primer sequence. Default to R1492. (default: AAGTCGTAACAAGGTARCY)
